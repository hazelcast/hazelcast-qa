...
package com.hazelcast.hzblame;

import com.hazelcast.hzblame.blame.Blame;
...
public final class HazelcastBlame {

    private HazelcastBlame() {
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        switch (commandLineOptions.getAction()) {
            ...
            case BLAME:
                Blame blame = new Blame(propertyReader, commandLineOptions);
                blame.run();
                break;
